...
def respond(
    ...
    # request_timer =   # Start timing the request
    ...
    with REQUEST_DURATION.time():
        ...
        try:
            ...
            yield history + [(message, f"Error: {str(e)}")], history, ""
        finally:
...
if __name__ == "__main__":
    ...
    demo.launch(server_name="0.0.0.0", server_port=7860, share=False)  # Launch Gradio app on port 7860
